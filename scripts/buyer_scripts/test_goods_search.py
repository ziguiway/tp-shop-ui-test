...
class TestGoodsSearch(object):
    ...
    def setup_method(self):
        ...
        self.driver = utils.DriverUtils.get_driver(DriverType.BUYER)
        # 尝试打开网页
    ...
    def test_goods_search(self, goods_name):
        ...
        try:
            assert utils.is_el_exist_by_text(DriverType.BUYER, "搜索结果") is True
            assert utils.is_el_exist_by_text(DriverType.BUYER, *goods_name) is True
